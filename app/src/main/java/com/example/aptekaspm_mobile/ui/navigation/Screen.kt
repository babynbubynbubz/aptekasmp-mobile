...
sealed class Screen(val route: String) {
    ...
    object Receive : Screen("receive_screen/{gid}/{sn}/{name}/{inn}/{inBoxAmount}") {
        fun createRoute(gid: String, sn: String, name: String, inn: String, inBoxAmount: Int): String {
    ...
    object Restock : Screen("restock_screen/{gid}/{sn}/{name}/{inn}/{inBoxAmount}/{remainingAmount}/{expiryDate}") {
        fun createRoute(
            gid: String,
            sn: String,
            name: String,
